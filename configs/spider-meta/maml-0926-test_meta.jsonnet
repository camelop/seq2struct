(import 'nl2code-0428-base.libsonnet')(output_from=false) {
    ...
    train+: {
        ...
        max_steps: 1000, # since we're using meta_learning
        keep_every_n: 100,
        eval_every_n: 10,
        save_every_n: 10,
    ...
    meta_learning: {
        ...
        */
        method: "maml", # or "reptile", "other"
        internal_step: 2, # how many steps for the internal model update, 2 for maml, >= 2 for reptile
        ...
        update_learning_rate: 1e-3, # the learning rate for internal update
